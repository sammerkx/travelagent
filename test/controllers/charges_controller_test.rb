...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post charges_url, params: { charge: { amount_payable: @charge.amount_payable, name: @charge.name, no_of_persons: @charge.no_of_persons } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { amount_payable: @charge.amount_payable, name: @charge.name, no_of_persons: @charge.no_of_persons } }
